...
public class AppRel implements Observer{
	...
	private static void startSystem() {
		...
		try {
			parser.parseXMLFile("ressources/testappctrrel.xml");
	...
	public synchronized void update(Observable arg0, Object arg1) {
		...
		try {
			Viereck chosen=getCoveredViereck(finger0X(), finger0Y());
			double winkeladd=(winkel.getData() * (180/Math.PI));
			if ((winkeladd<20 && winkeladd>-20) && chosen !=null && arg0==controller.findModul(23)){
				chosen.addAngle(-(int) (winkel.getData() * (180/Math.PI)));
				System.out.println("added angle:" + (int) (winkel.getData() * (180/Math.PI)));
			}
