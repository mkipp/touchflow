#include "/usr/lib/jvm/java-6-sun-1.6.0.20/include/jni.h"
#include <m_pd.h>
...
// the JVM takes 50M; I don't care taking 4K for reading the properties file
#define BUFFER_SIZE 4096

// MAXIMUM atom[x] size for type casting from jatoms to atoms
#define MAX_ATOMS_STACK 1024
...
typedef struct PdjCaching {
    ...
    jmethodID   MIDMaxObject_processInlet;
